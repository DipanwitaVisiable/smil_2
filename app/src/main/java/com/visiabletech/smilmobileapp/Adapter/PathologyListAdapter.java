...
public class PathologyListAdapter extends RecyclerView.Adapter<PathologyListAdapter.ViewHolder> {


    private Context context;
    private ArrayList<PathologyListModel> mList;

    public PathologyListAdapter(Context context, ArrayList<PathologyListModel> list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view=layoutInflater.inflate(R.layout.custom_pathology_list,parent,false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        final PathologyListModel chamberModel=mList.get(position);
