...
import com.visiabletech.smilmobileapp.PathologyServicesActivity;
...
public class PathologyAdapter extends RecyclerView.Adapter<PathologyAdapter.ViewHolder> {
    ...
    private ArrayList<PathologyModel> mList;

    public PathologyAdapter(Context context, ArrayList<PathologyModel> list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view=layoutInflater.inflate(R.layout.custom_pathology,parent,false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        final PathologyModel chamberModel=mList.get(position);
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            lin.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    context.startActivity(new Intent(context, PathologyServicesActivity.class));
