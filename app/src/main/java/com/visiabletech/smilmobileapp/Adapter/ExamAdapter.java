...
import com.visiabletech.smilmobileapp.ExamDetailsActivity;
...
public class ExamAdapter extends RecyclerView.Adapter<ExamAdapter.ViewHolder> {
    ...
    public ExamAdapter(Context context, ArrayList<ExamModel> list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view=layoutInflater.inflate(R.layout.custom_exam,parent,false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        final ExamModel chamberModel=mList.get(position);
