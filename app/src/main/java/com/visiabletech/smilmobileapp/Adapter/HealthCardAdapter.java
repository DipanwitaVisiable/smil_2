...
public class HealthCardAdapter extends RecyclerView.Adapter<HealthCardAdapter.ViewHolder> {
    ...
    private ArrayList<HealthCardModel> mList;

    public HealthCardAdapter(Context context, ArrayList<HealthCardModel> list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view=layoutInflater.inflate(R.layout.custom_health_card,parent,false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        final HealthCardModel chamberModel=mList.get(position);
