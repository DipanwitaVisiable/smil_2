...
import com.visiabletech.smilmobileapp.PathologyListActivity;
...
public class PathologyServicesAdapter extends RecyclerView.Adapter<PathologyServicesAdapter.ViewHolder> {
    ...
    private ArrayList<PathologyServicesModel> mList;

    public PathologyServicesAdapter(Context context, ArrayList<PathologyServicesModel> list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view=layoutInflater.inflate(R.layout.custom_pathology_services,parent,false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        final PathologyServicesModel chamberModel=mList.get(position);
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            lin.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    context.startActivity(new Intent(context, PathologyListActivity.class));
