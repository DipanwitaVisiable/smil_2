...
public class TermExamAnswerAdapter extends RecyclerView.Adapter<TermExamAnswerAdapter.ansViewHolder> {
  ...
  public TermExamAnswerAdapter(Context context, List<AnswerTable> ansList, String question, String questionId, Button btn_save_next, Integer selectedPosition) {
  ...
  @NonNull
  @Override
  public TermExamAnswerAdapter.ansViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int position) {
    LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    assert inflater != null;
    View view = inflater.inflate(R.layout.item_small_quiz_answer_adapter, parent, false);
    return new TermExamAnswerAdapter.ansViewHolder(view);
  }

  @Override
  public void onBindViewHolder(@NonNull TermExamAnswerAdapter.ansViewHolder viewHolder, final int position) {
