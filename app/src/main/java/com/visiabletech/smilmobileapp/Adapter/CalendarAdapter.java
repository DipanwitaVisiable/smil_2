...
import com.visiabletech.smilmobileapp.Utils.Util;
...
public class CalendarAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (dayString.get(position).equals(curentDateString)) {
            ...
            dayView.setBackgroundResource(R.color.colorTransparent);
        }
            ...
            if (attendanceInfo.getAttendence_status().equalsIgnoreCase("a")) {
                ...
                if (currMonth != gridMonthInt) {
                    ...
                    if (dayString.get(position).equalsIgnoreCase(attendanceInfo.getDate())) {
                        ...
                        dayView.setBackgroundResource(R.drawable.absent_background);
                 ...
                 if (currMonth != gridMonthInt) {
                    ...
                    if (dayString.get(position).equalsIgnoreCase(attendanceInfo.getDate())) {
                        ...
                        dayView.setBackgroundResource(R.drawable.present_background);
                    }
                }
