...
//     CountDownTimer countDownTimer;
    ...
    private void saveQuiz() {
        ...
        stringRequest_saveQuiz=new StringRequest(Request.Method.POST, Const.BASE_SERVER + "save_question",
    ...
    private void submitTestApiCall() {
        ...
        stringRequest_saveQuiz=new StringRequest(Request.Method.POST, Const.BASE_SERVER + "submit_test",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try {
    ...
    private void getAllQuestion() {
        ...
        answerLoad.setVisibility(View.VISIBLE);
        stringRequest_getQuestion=new StringRequest(Request.Method.POST, Const.BASE_SERVER + "start_test",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try {
...
//                                            preButton.setVisibility(View.VISIBLE);
  ...
  private void getOnlyQuestionApiCall(final String questionId, final int ques_pos) {
    ...
    StringRequest request = new StringRequest(Request.Method.POST, Const.BASE_SERVER + "get_small_question",
      new Response.Listener<String>() {
